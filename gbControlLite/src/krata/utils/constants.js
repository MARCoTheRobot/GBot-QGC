...
export const GITHUB_AUTH_URL = `https://github.com/login/oauth/authorize?client_id=${
  import.meta.env.VUE_APP_GITHUB_CLIENT_ID
...
export const GOOGLE_AUTH_URL = `https://accounts.google.com/o/oauth2/auth/identifier?client_id=${
  import.meta.env.VUE_APP_GAUTH_CLIENT_ID
}&prompt=consent&redirect_uri=${import.meta.env.VUE_APP_URL}/auth/login&state=google_${uuid()}&response_type=code&scope=profile email&service=lso&o2v=1&flowName=GeneralOAuthFlow`;
