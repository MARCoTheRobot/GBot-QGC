...
<script>
import BaseMapOptions from "@/krata/components/studio/ItemOptions/BaseMapOptions.vue";
import FeatureOptions from "@/krata/components/studio/ItemOptions/FeatureOptions.vue";
import MultiFeatureOptions from "@/krata/components/studio/ItemOptions/MultiFeatureOptions.vue";

import { useStoreModule } from "@/krata/composables/useStoreModule";
import { computed } from "vue";
import { FEATURE_TYPES } from "@/krata/models/Feature.model";
