<template>
  <div class="editor-view">
    <map-view
      ...
      @on-click="onClickMap"
      @on-drag-start="() => setIsDragging(true)"
      @on-drag-end="() => setIsDragging(false)"
    />
    <GeoPopup
...
import {
  EDITING_MODE,
  MAP_TOOLS,
} from "@/krata/store/modules/editor/initialState.js";
import { DISTANCE_SCALE } from "@/krata/utils/constants";
