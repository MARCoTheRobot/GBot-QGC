...
<script>
import ClearIcon from "@/krata/components/icons/ClearIcon.vue";
import LinkIcon from "@/krata/components/icons/LinkIcon.vue";
import PublicIcon from "@/krata/components/icons/PublicIcon.vue";
import { computed, ref } from "vue";
import { useStoreModule } from "@/krata/composables/useStoreModule";
import VInput from "@/krata/components/base/v-input.vue";
import VButton from "@/krata/components/base/v-button.vue";
import VTextarea from "@/krata/components/base/v-textarea.vue";
// import { createRoute } from "@/krata/router";
