...
<script>
import SelectIcon from "@/krata/components/icons/SelectIcon.vue";
import GitHubIcon from "@/krata/components/icons/GitHubIcon.vue";
import DotIcon from "@/krata/components/icons/DotIcon.vue";
...
import MeasureIcon from "@/krata/components/icons/MeasureIcon.vue";
import HandIcon from "@/krata/components/icons/HandIcon.vue";
import DownloadIcon from "@/krata/components/icons/DownloadIcon.vue";
import ShareIcon from "@/krata/components/icons/ShareIcon.vue";
import EllipseIcon from "@/krata/components/icons/EllipseIcon.vue";
import RectangleIcon from "@/krata/components/icons/RectangleIcon.vue";
import PolygonIcon from "@/krata/components/icons/PolygonIcon.vue";
import CrossHairIcon from "@/krata/components/icons/CrossHairIcon.vue";
import KeyboardArrowIcon from "@/krata/components/icons/KeyboardArrowDownIcon.vue";
import Logo from "@/krata/components/icons/AppLogo.vue";
import DownloadOptions from "@/krata/components/studio/Menus/DownloadOptions.vue";
import { MAP_TOOLS } from "@/krata/store/modules/editor/initialState.js";
import { computed, ref, watch } from "vue";
import { useStoreModule } from "@/krata/composables/useStoreModule.js";
import LockIcon from "@/krata/components/icons/LockIcon.vue";
