...
<script>
import WidthIcon from "@/krata/components/icons/WidthIcon.vue";
import RadiusIcon from "@/krata/components/icons/RadiusIcon.vue";
import VDropdown from "@/krata/components/base/v-dropdown.vue";
import { DISTANCE_SCALE } from "@/krata/utils/constants.js";
