...
<script>
import NavBar from "@/krata/components/studio/NavBar.vue";
import ExplorerPanel from "@/krata/components/studio/Explorer/ExplorerPanel.vue";
import DetailsPanel from "@/krata/components/studio/DetailsPanel.vue";
import FileImportModal from "@/krata/components/studio/Dialogs/FileImportModal.vue";
...
import { useStoreModule } from "@/krata/composables/useStoreModule";
import { useRoute } from "vue-router";
import StudioSkeletonLoader from "@/krata/components/studio/StudioSkeletonLoader.vue";
import GenerateImageModal from "@/krata/components/studio/Dialogs/ImageGenerationDialog.vue";
import ShareMapModal from "@/krata/components/studio/Dialogs/ShareMapModal.vue";
import MapSearch from "@/krata/components/studio/Dialogs/MapSearch.vue";
import EditorLoader from "@/krata/components/studio/Editor/EditorLoader.vue";
const EditorView = defineAsyncComponent({
  loader: () => import("@/krata/components/studio/Editor/EditorView.vue"),
