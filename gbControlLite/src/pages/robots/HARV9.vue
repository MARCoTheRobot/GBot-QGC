<template>
	...
	<Slider v-model="cameraTilt" orientation="vertical" class="fixed left-10 h-14rem top-12" />

	<!--Options Sidebar-->
	<Sidebar v-model:visible="showSettingsSidebar">
	...
	<button class="fixed p-5 border-white rounded-full bottom-48 right-12 bg-gray-900/20 outline hover:bg-slate-300/20" @click="startStopMicrophone"><IconMicrophone class="w-8 h-8" /></button>
...
const cameraTilt = ref<number>(0);
const showSettingsSidebar = ref<boolean>(false);
