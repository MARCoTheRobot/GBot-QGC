...
MacBuild {
    ...
    ICON                = $${SOURCE_DIR}/resources/icons/GuardBotMacx.icns
...
WindowsBuild {
    RC_ICONS = resources/icons/GuardBot.ico
...
LinuxBuild {
    ...
    share_icons.files = $${IN_PWD}/resources/icons/GuardBot.png
